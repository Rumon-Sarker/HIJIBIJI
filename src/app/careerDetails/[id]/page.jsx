    ...
    <div>
      ...
      <div className="mx-5 md:mx-10 lg:mx-20">
        ...
        <div className="my-10">
          ...
          <div>
            <form className="p-10 lg:p-20 space-y-3 bg-base-100 shadow-xl rounded-md">
              ...
              <span className="mt-10">Attach CV*</span>
              ...
              <div className="flex justify-end">
                <button className="btn bg-main hover:border-2 hover:border-main text-white hover:text-black hover:bg-transparent my-5">
                  Submit
                </button>
              </div>
            </form>
