...
const CaseStudyDetails = async ({ params }) => {
  ...
  return (
    <div>
      <div className="h-[200px] bg-main mx-5 lg:mx-10 flex justify-center items-center rounded-lg my-5">
      ...
      <div className="p-5 mx-0 md:mx-10 lg:mx-20 bg-base-100 shadow-xl rounded-md">
        <h1 className="text-center text-main text-3xl my-10">{caseStudy.name}</h1>
