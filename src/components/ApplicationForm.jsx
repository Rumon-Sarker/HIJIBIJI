...
const ApplicationForm = () => {
    ...
    return (
        <div>
          ...
          <div>
            <form action={handlePost} className="p-10 lg:p-20 space-y-3 bg-base-100 shadow-xl rounded-md">
              ...
              <div className="md:flex justify-between flex-row gap-20 w-full">
                <label className="form-control w-full max-w-xs">
                  ...
                  <select required name="gender" className="select select-bordered">
              ...
              <div className="flex w-full items-center justify-center">
                ...
                >
                  ...
                  <FileInput required name="image" id="dropzone-file" className="hidden" />
                </Label>
              </div>
              <div className="flex justify-end">
                <button type="submit" className="btn bg-main hover:border-2 hover:border-main text-white hover:text-black hover:bg-transparent my-5">
                  Submit
                </button>
              </div>
            </form>
